...
export function getWeatherAdvice(temp, isRaining) {
  ...
  else if (temp >= 25) return isRaining ? "Warm but rainy - consider indoor activities" : "Great weather for hiking - don't forget sunscreen";
  else if (temp >= 15) return isRaining ? "Cool and rainy - bring waterproof gear if hiking" : "Perfect hiking weather - enjoy the trails";
  else if (temp >= 5) return isRaining ? "Cold and wet - best to stay indoors" : "Chilly - wear layers for your hike";
